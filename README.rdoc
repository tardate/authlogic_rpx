...
The user model will have a has_many relationship with a new model, called RPXIdentifier. Create a migration to add this.
...
The user model then needs to be tagged with "acts_as_authentic", and you must add the relationship with RPXIdentifiers.
